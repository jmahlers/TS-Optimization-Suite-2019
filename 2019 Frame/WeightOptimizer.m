function [AreaMatrix,Weight,Stiffness,OptimizedFrameData]=WeightOptimizer(refFrame,Seed,NumGens,GenSize,numSurv,TargetTS,plotThicknesses,squareTubes)
...
minRefFrame = GeometryAndLoadingForThicknessOptimizers_2019Frame(thicknesses);
